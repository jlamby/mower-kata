...
class RightCommandTest {
    ...
    @Test
    void should_head_west_when_turning_right_from_the_north() {
    ...
    @Test
    void should_head_south_when_turning_right_from_the_west() {
    ...
    @Test
    void should_head_east_when_turning_right_from_the_south() {
        Mower mower = new Mower(new Position(1, 2, Orientation.SOUTH));
    ...
    @Test
    void should_head_north_when_turning_right_from_the_east() {
